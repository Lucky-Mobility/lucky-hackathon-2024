...
const socialNetworks: Array<SocialNetworkIconProps> = [
  {
    type: "facebook",
    link: "https://facebook.com/shadcn",
  },
  {
    type: "instagram",
    link: "https://instagram.com/shadcn",
  },
  {
    type: "tik-tok",
    link: "https://tiktok.com/shadcn",
  },
  {
    type: "youtube",
    link: "https://youtube.com/shadcn",
  },
  {
    type: "pinterest",
    link: "https://pinterest.com/shadcn",
  },
];

export const InfluencerInfo = () => {
  const socialNetworkIcons = socialNetworks.map((network) => (
    <SocialNetworkIcon key={network.type} {...network} />
  ));
  return (
